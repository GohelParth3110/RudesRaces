    ...
    public class CharacterEditor : MonoBehaviour
    {
        ...
        public void OnSelectTab(bool value)
        {
            ...
            switch (tab.name)
            {
                case "Armor":
                {
                    var sprites = SpriteCollection.Armor.OrderBy(i => i.Id).ToList();
                ...
                case "Shield":
                {
                    var sprites = SpriteCollection.Shield.OrderBy(i => i.Id).ToList();
                ...
                case "Melee1H":
                {
                    var sprites = SpriteCollection.MeleeWeapon1H.OrderBy(i => i.Id).ToList();
                ...
                case "Bow":
                {
                    var sprites = SpriteCollection.Bow.OrderBy(i => i.Id).ToList();
                ...
                case "Crossbow":
                {
                    var sprites = SpriteCollection.Crossbow.OrderBy(i => i.Id).ToList();
                ...
                case "Firearm1H":
                {
                    var sprites = SpriteCollection.Firearm1H.OrderBy(i => i.Id).ToList();
                ...
                case "Firearm2H":
                {
                    var sprites = SpriteCollection.Firearm2H.OrderBy(i => i.Id).ToList();
                ...
                case "Body":
                {
                    var sprites = SpriteCollection.Body.OrderBy(i => i.Id).ToList();
                ...
                case "Ears":
                {
                    var sprites = SpriteCollection.Ears.OrderBy(i => i.Id).ToList();
                ...
                case "Eyebrows":
                {
                    var sprites = SpriteCollection.Eyebrows.OrderBy(i => i.Id).ToList();
                ...
                case "Eyes":
                {
                    var sprites = SpriteCollection.Eyes.OrderBy(i => i.Id).ToList();
                ...
                case "Hair":
                {
                    var sprites = SpriteCollection.Hair.OrderBy(i => i.Id).ToList();
                ...
                case "Beard":
                {
                    var sprites = SpriteCollection.Beard.OrderBy(i => i.Id).ToList();
                ...
                case "Mouth":
                {
                    var sprites = SpriteCollection.Mouth.OrderBy(i => i.Id).ToList();
                ...
                case "Makeup":
                {
                    var sprites = SpriteCollection.Makeup.OrderBy(i => i.Id).ToList();
                ...
                case "Mask":
                {
                    var sprites = SpriteCollection.Mask.OrderBy(i => i.Id).ToList();
                ...
                case "Earrings":
                {
                    var sprites = SpriteCollection.Earrings.OrderBy(i => i.Id).ToList();
                ...
                case "Supplies":
                {
                    var sprites = SpriteCollection.Supplies.OrderBy(i => i.Id).ToList();
