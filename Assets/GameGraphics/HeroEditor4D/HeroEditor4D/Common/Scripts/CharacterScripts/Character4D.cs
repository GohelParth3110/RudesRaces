...
namespace Assets.HeroEditor4D.Common.Scripts.CharacterScripts
{
	...
	public class Character4D : MonoBehaviour
    {
        ...
        public List<Sprite> Body { set { Parts.ForEach(i => i.Body = value); } }
        ...
        public List<Sprite> Ears { set { Parts.ForEach(i => i.Ears = value); } }
        ...
        public List<Sprite> Armor { set { Parts.ForEach(i => i.Armor = value); } }
        ...
        public List<Sprite> Shield { set { Parts.ForEach(i => i.Shield = value); } }
        public List<Sprite> CompositeWeapon { set { Parts.ForEach(i => i.CompositeWeapon = value); } }
        ...
        public List<Sprite> Earrings { set { Parts.ForEach(i => i.Earrings = value); } }
        ...
        public void ApplyFirearmParams(FirearmParams firearmParams)
        {
            for (var i = 0; i < 4; i++)
            {
                Parts[i].AnchorFireMuzzle.localPosition = new Vector2(0.25f * (Parts[i] == Left ? 1 : -1), firearmParams.FireMuzzlePosition);
            }
        }
    }
}